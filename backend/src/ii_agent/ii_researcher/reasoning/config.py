...
from ii_agent.ii_researcher.config import SEARCH_PROVIDER
...
class LLMConfig(BaseModel):
    ...
    model: str = Field(default_factory=lambda: os.getenv("R_MODEL", "qwen3:30b"))
    ...
    report_model: str = Field(default_factory=lambda: os.getenv("R_REPORT_MODEL", "qwen3:30b"))
