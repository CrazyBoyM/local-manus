...
COMPRESS_SIMILARITY_THRESHOLD = float(os.getenv("COMPRESS_SIMILARITY_THRESHOLD", "0.30"))
COMPRESS_EMBEDDING_MODEL = os.getenv("COMPRESS_EMBEDDING_MODEL", "bge-large:latest")
